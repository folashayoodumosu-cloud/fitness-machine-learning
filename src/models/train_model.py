...
feature_set_4 = feature_set_3 + frequency_features + cluster_features
...
0.2 + 0.1 == 0.3 #false, due to floating point precision issues. Use np.isclose() instead
max_features = 10
